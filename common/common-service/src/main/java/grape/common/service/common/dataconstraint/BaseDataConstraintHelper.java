 ...
 */
@Component
public class BaseDataConstraintHelper<user extends GrapeUserDetails> {
    ...
    public List<ConstraintCompiledContent> doParseConstraint(String dataObjectCode, user loginUser){

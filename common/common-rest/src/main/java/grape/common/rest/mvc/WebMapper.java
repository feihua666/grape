 ...
 */
public interface WebMapper<Vo extends BaseVo,Po extends NormalBasePo<Po>,CreateForm extends BaseForm, UpdateForm extends BaseForm, ListForm extends BasePageForm> {
    /**
     * 单表创建表单转po
     * @param cf
     * @return

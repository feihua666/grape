...
@ApiModel(value="数据范围分配岗位表单对象")
public class DataScopeAssignPostForm extends BaseForm {
    ...
    @NotEmpty(message = "选择的岗位id不能为空")
    @ApiModelProperty(value = "选择的岗位id",required = true)
